...
df = pd.read_csv(r'C:\Users\hr_automations\UUS_PC_PeopleAnalytics_Automation\Python_Jobs\Employee Leave Experience Lifecycle.csv', header = 0,  skiprows=lambda x: x in [0, 2])
...
df_subset.to_csv(r'C:\Users\hr_automations\UUS_PC_PeopleAnalytics_Automation\Python_Jobs\leave_experience_deidentified_data_{0}.csv'.format(date), na_rep='')
...
sender = 'cwymer@unum.com'
recipients = ['cwymer@unum.com','KPreble@UNUM.COM']
subject = (date + " " + 'Leave Experience Data Export' )
body = 'Leave data export from Qualtrics is attached to this email'
attach_path = (r'C:\Users\hr_automations\UUS_PC_PeopleAnalytics_Automation\Python_Jobs\leave_experience_deidentified_data_{0}.csv'.format(date))
