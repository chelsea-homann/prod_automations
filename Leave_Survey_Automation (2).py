...
def sftp_transfer(username, password, myHostname):
    ...
    try:
        ...
        sftp.put('C:\\Users\\hr_automations\\UUS_PC_PeopleAnalytics_Automation\\Python_Jobs\\leave_survey_automation\\LEAVE.csv', \
...
def main():
    ...
    try:
        ...
        deduped.to_csv('C:\\Users\\hr_automations\\UUS_PC_PeopleAnalytics_Automation\\Python_Jobs\\leave_survey_automation\\LEAVE.csv', index=False)
        print('CSV Created!')
    ...
    try:
        ...
        subject = 'Job Failed!'
        body = 'Job Failed!'
        UnumEmail.send_email(sender, recipients, subject, body, file_attached = True, attachment = 'LEAVE.csv', attach_path = 'C:\\Users\\hr_automations\\UUS_PC_PeopleAnalytics_Automation\\Python_Jobs\\leave_survey_automation\\LEAVE.csv')
        sys.exit()
        
    os.remove('C:\\Users\\hr_automations\\UUS_PC_PeopleAnalytics_Automation\\Python_Jobs\\leave_survey_automation\\LEAVE.csv')
